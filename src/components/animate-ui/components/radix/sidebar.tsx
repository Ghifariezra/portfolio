...
import { TooltipProvider } from "../../primitives/radix/tooltip";
...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// biome-ignore lint/suspicious/noDocumentCookie: Diperlukan oleh Shadcn untuk menyimpan state sidebar
...
function SidebarTrigger({ className, onClick, ...props }: SidebarTriggerProps) {
	...
	return (
		<Button
			...
			{...props}
		>
			<SquaresFour size={18} className="text-foreground" />
