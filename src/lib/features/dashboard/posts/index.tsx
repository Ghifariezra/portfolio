...
function FilterButton({
    ...
    return (
        <button
            type="button"
            onClick={onClick}
            className={`px-5 py-2 rounded font-mono text-[11px] font-semibold tracking-wider uppercase transition-all duration-200 cursor-pointer shadow-brutal-sm dark:shadow-none ${active
                ...
                <div className="max-w-7xl mx-auto flex flex-col gap-6">
                    ...
                    <div className="flex flex-wrap items-center gap-3 pb-6 border-b-2 dark:border-b border-border">
                        ...
                        <FilterButton active={filter === "draft"} onClick={() => setFilter("draft")}>
                            Drafts{" "}
                            <span className="ml-1.5 opacity-60">({counts.draft})</span>
                        </FilterButton>
